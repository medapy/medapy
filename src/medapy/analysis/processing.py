...
from medapy.utils.validations import validate_option, validate_xy
...
def select_range_df(
    ...
    inclusive = validate_option(inclusive, ['both', 'neither', 'left', 'right'], 'inclusive')
    handle_na = validate_option(handle_na, ['exclude', 'raise'], 'handle_na')
...
def savgol_filter(
    ...
    **kwargs :
    ...
    align = validate_option(align, valid_align, 'align')
